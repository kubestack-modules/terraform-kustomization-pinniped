# Pinniped Terraform Module

This module installs Pinniped on Kubernetes.
...
The module bundles an upstream release of Pinniped and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/pinniped/kustomization"
